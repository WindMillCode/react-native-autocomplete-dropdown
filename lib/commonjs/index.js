...
const AutocompleteDropdown = exports.AutocompleteDropdown = /*#__PURE__*/(0, _react.memo)(/*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const dropdownHeight = (0, _reactNativeReanimated.useSharedValue)(0);
  const dropdownOpacity = (0, _reactNativeReanimated.useSharedValue)(0);
  const animatedStyles = (0, _reactNativeReanimated.useAnimatedStyle)(() => ({
    height: dropdownHeight.value,
    opacity: dropdownOpacity.value
  }));
  (0, _react.useEffect)(() => {
    const itemHeight = (0, _reactNativeSizeMatters.moderateScale)(40); // Match your item height
    const itemsCount = dataSet?.length || 0;
    const calculatedHeight = Math.min(itemsCount * itemHeight, suggestionsListMaxHeight);
    if (isOpened && itemsCount > 0) {
      dropdownHeight.value = (0, _reactNativeReanimated.withTiming)(calculatedHeight, {
        duration: 250,
        easing: _reactNativeReanimated.Easing.out(_reactNativeReanimated.Easing.ease)
      });
      dropdownOpacity.value = (0, _reactNativeReanimated.withTiming)(1, {
        duration: 200
      });
    } else {
      dropdownHeight.value = (0, _reactNativeReanimated.withTiming)(0, {
        duration: 200
      });
      dropdownOpacity.value = (0, _reactNativeReanimated.withTiming)(0, {
        duration: 150
      });
    }
  ...
  (0, _react.useEffect)(() => {
    ...
    setContent(/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeReanimated.default.View, {
  ...
  }, [activeInputContainerRef, dataSet, direction, inputHeight, props, renderItem, setContent, suggestionsListMaxHeight, animatedStyles // Add this to dependencies
  ]);
