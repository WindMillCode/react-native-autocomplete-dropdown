...
const AutocompleteDropdownContextProvider = ({
  ...
  const contentStylesAnimated = (0, _react.useRef)(new _reactNative.Animated.ValueXY()).current;
  (0, _react.useEffect)(() => {
    ...
    activeInputContainerRef?.current?.measure((x, y, width, height, inputPageX, inputPageY) => {
      wrapperRef.current?.measure((wrapperX, wrapperY, wrapperW, wrapperH, wrapperPageX, wrapperPageY) => {
        ...
        if (contentStyles && currentMeasurement) {
          _reactNative.Animated.timing(contentStylesAnimated, {
            toValue: {
              x: currentMeasurement.x,
              y: direction === 'up' ? currentMeasurement.bottomY - dropdownHeight - 5 - headerOffset : currentMeasurement.topY + currentMeasurement.height + 5 + headerOffset
            },
            duration: 200,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(AutocompleteDropdownContext.Provider, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
      ...
      children: children
    }), !!content && show && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Animated.View, {
      onLayout: onLayout,
      style: [{
        ...styles.wrapper,
        opacity
