...
import { Dimensions, Keyboard, Platform, Pressable, TextInput, TouchableOpacity, View, useColorScheme, LayoutAnimation, Animated } from 'react-native';
...
export const AutocompleteDropdown = /*#__PURE__*/memo(/*#__PURE__*/forwardRef((props, ref) => {
  ...
  useEffect(() => {
    ...
    setContent(/*#__PURE__*/_jsx(Animated.View, {
      style: [{
        height: heightAnim,
        opacity: opacityAnim,
        overflow: 'hidden'
  ...
  }, [activeInputContainerRef, dataSet, direction, inputHeight, props, renderItem, setContent, suggestionsListMaxHeight, heightAnim, opacityAnim]);
